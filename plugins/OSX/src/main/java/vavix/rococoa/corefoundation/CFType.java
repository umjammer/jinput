 ...
 *
 * @author semaphore
 * @version May 27, 2010 1:07:46 AM
 */
public class CFType extends PointerType {
    ...
    public int getType() {
        return CFLib.INSTANCE.CFGetTypeID(this).intValue();
    }

    public String getDescription() {
        return CFLib.INSTANCE.CFCopyDescription(this).getString();
    }

    public String getTypeDescription() {
        return CFLib.INSTANCE.CFCopyTypeIDDescription(CFLib.INSTANCE.CFGetTypeID(this)).getString();
    }
